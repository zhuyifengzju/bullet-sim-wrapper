...
class SpaceMouse(Device):
    ...
    def get_controller_state(self):
        ...
        drot1 = rotation_matrix3(angle=-pitch, direction=[1., 0, 0], point=None)[:3, :3]
        drot2 = rotation_matrix3(angle=roll, direction=[0, 1., 0], point=None)[:3, :3]
        drot3 = rotation_matrix3(angle=yaw, direction=[0, 0, 1.], point=None)[:3, :3]
